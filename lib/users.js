...
export const readUsersAttendedCondition = async (condition) => {
  let result = 0;

  try {
    const sresult = await dbConnect
      .collection("users")
      .find({ ATTENDED: condition });
...
export const searchUsersInput = async (input, search) => {
